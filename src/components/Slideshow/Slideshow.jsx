...
export default function Slideshow({pictureList}) {
    ...
    <div className="slideShowContainer" >
        ...
        <div className='arrowContainer' style={{display : styleDisplay}}  >
            <p className='previous' onClick={chevronPrevious}> <img src={arrowLeft} alt="Chevron left" /> </p>
            <p className='next' onClick={chevronNext}> <img src={arrowRight} alt="Chevron right" /> </p> 
        </div>
    </div>
    );
}